...
#define DECELERATION_MULTIPLIER 7.0f
...
//            return [(id<iCarouselDelegate>)_delegate carousel:self valueForOption:nil withDefault:offset];
        }
    }
...
- (UIView *)containView:(UIView *)view
{
    ...
    //add tap gesture recogniser
    UILongPressGestureRecognizer *longTapGesture = [[UILongPressGestureRecognizer alloc] initWithTarget:self action:@selector(didlongPress:)];
    longTapGesture.delegate = (id <UIGestureRecognizerDelegate>)self;
    [containerView addGestureRecognizer:longTapGesture];
...
- (void)didlongPress:(UILongPressGestureRecognizer *)tapGesture
{
    NSLog(@"didlongPress");
