...
- (void) drawRect:(CGRect)rect
{
    ...
    CGRect bounds = CGRectMake(0 , 0, numberSize.width + 15 , 18);
...
- (void) layoutSubviews
{
    ...
    if(self.badgeString)
    {
        ...
        CGSize badgeSize = [self.badgeString sizeWithFont:[UIFont boldSystemFontOfSize: 13]];
        CGRect badgeframe = CGRectMake(self.contentView.frame.size.width - (badgeSize.width + 20),
