...
@synthesize friendsListViewController,timelineScrollViewController,eventListController,appDelegate;
...
- (void) bumpDataReceived:(NSData *)chunk{
    ...
    if (function==0) {
        ...
        [k setDelegate:self];
        [k inviteFriendsWithRole:[NSString stringWithFormat:@"Member"] andIsConfirm:1 andEventID:[self eventID] andUserID:[[friend objectForKey:@"userDBID"] intValue]];
        //update tableview
        
    }
    else if(function==2) {
        [eventListController reloadTableViewDataSource];
    }
