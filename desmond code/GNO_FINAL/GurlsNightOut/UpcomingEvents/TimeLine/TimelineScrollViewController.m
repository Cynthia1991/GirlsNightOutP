...
- (void)viewDidLoad
{
    ...
    timelineNavigationController.view.frame=CGRectMake(640, 0, 320, 460);
...
//    rootViewController.timelineManager=appDelegate.timelineManager;
    ...
    addDrinksNavigationController.view.frame=CGRectMake(960, 0, 320, 460);
    ...
    quickDialNavigationController.view.frame=CGRectMake(320, 0, 320, 460);
    ...
    self.gameNavigationController.view.frame=CGRectMake(0, 0, 320, 460);
...
//    UIView *view=[[UIView alloc] initWithFrame:CGRectMake(0, 0, 320, 460)];
    ...
    myScrollView.contentSize=CGSizeMake(320*4, 460);
	...
	// Do any additional setup after loading the view.
    self.scvTimelineInstruction.contentSize=CGSizeMake(320*7, 460);
