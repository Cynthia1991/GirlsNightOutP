...
//        [_handContainer release];
        ...
        _timeLabel = [[UILabel alloc] initWithFrame:CGRectMake(35.0f, 4.0f, 50.0f, 20.0f)];
...
//        [_timeLabel release];
        ...
        _dateLabel = [[UILabel alloc] initWithFrame:CGRectMake(35.0f, 11.0f, 100.0f, 20.0f)];
        _dateLabel.textColor = [UIColor colorWithRed:255.0/255 green:99.0/255 blue:240.0/255 alpha:1.0f];
...
//        [_lastDate release];
    ...
    if (dateComponents.year == todayComponents.year && dateComponents.month == todayComponents.month && dateComponents.day == todayComponents.day) {
        ...
        timeLabelFrame = CGRectMake(35.0f, 4.0f, 100.0f, 20.0f);
        dateLabelAlpha = 0.0f;
        ...
        timeLabelFrame = CGRectMake(35.0f, 4.0f, 100.0f, 10.0f);
