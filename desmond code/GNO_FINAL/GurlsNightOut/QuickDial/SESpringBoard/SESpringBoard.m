...
- (id) initWithTitle:(NSString *)boardTitle items:(NSMutableArray *)menuItems image:(UIImage *) image{
    self = [super initWithFrame:CGRectMake(0, 0, 320, 345)];
...
//        [self addSubview:navigationBar];
        ...
        itemsContainer = [[UIScrollView alloc] initWithFrame:CGRectMake(10, 5, 310, 310)]; // changed for vertical
        ...
        itemsContainer.indicatorStyle = UIScrollViewIndicatorStyleWhite;
        ...
        for (SEMenuItem *item in self.items) {
            ...
            [item setFrame:CGRectMake(item.frame.origin.x + horgap , item.frame.origin.y + vergap + (currentPage*375), 100, 100)]; // changed for vertical
        ...
        [itemsContainer setContentSize:CGSizeMake(itemsContainer.frame.size.width, numberOfPages*375)];

        // add a page control representing the page the scrollview controls
//        pageControl = [[UIPageControl alloc] initWithFrame:CGRectMake(0, 310, 320, 20)];
//        if (numberOfPages > 1) {
