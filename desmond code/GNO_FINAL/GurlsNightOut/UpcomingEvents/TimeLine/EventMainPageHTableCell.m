...
@implementation EventMainPageHTableCell
@synthesize ivIcon,lbName,lbPostContent,lbPostTime,ivPhoto,btCommentDisplay,btLikeDisplay,btLike,btComment,postID,eventID,timelineCellKumulos,lbLikeDisplay,lbCommentDisplay,userID,commentArray,likeArray,vLikeDisplay,vCommentDisplay,ivBackground1;
...
- (IBAction)CommentAction:(id)sender
{
    ...
    [dic setObject:[NSString stringWithFormat:@"1"] forKey:@"cellType"];
